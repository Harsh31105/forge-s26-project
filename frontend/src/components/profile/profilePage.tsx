...
export function FavoritesCard({
    ...
    <section className="border border-border bg-surface p-8 shadow-sm">
        ...
        {items.length > 0 ? (
            ...
            >
                <span className="font-body text-[24px] font-semibold text-foreground">
                    {item}
                </span>
...
export function FavoritesCourseRow({
    ...
    return (
        <div className="flex items-center justify-between px-6 py-5 bg-background">
            <span className="font-body text-[24px] font-semibold text-foreground">
            ...
            <button
                ...
                className="text-[22px] text-foreground hover:text-error transition-colors"
