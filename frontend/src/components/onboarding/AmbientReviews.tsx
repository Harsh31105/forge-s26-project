...
function ReviewBubble({ card, blink }: BubbleProps) {
  ...
  const isProfReview = !!review.professorName;
  ...
  return (
    ...
    >
      {/* Course / professor header */}
      <div style={{ marginBottom: "5px", lineHeight: 1.2 }}>
        <span style={{
          fontSize: "11px", fontWeight: 700,
          color: isProfReview ? "#b45309" : "var(--color-primary-navy)",
          letterSpacing: "0.04em", fontFamily: FONT,
        }}>
          {isProfReview ? `Prof. ${review.professorName}` : review.courseCode}
        </span>
      ...
      {/* Typewriter text — italic + quoted */}
      <div style={{
        fontSize: "12px", lineHeight: 1.55, color: "var(--color-text-primary)",
        minHeight: "38px", marginBottom: "6px", fontFamily: FONT,
        fontStyle: "italic",
      }}>
        &ldquo;{visible}
        {typing && blink && (
