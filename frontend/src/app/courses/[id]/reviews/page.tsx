...
export default function CourseReviewsPage() {
  ...
  const courseReviews = useMemo(
    () => reviews.filter(r => (r as any).courseId === id),
    [reviews, id]
  );
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h1 style={{
              ...
              Reviews for {courseName} ({courseReviews.length})
            </h1>
      ...
      <div style={{ display: "flex", gap: "14px" }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <p style={{
            ...
            {[semLabel, review.createdAt && formatDate(review.createdAt)]
              .filter(Boolean).join(" • ")}
          </p>

          {/* Would take again tag */}
          {review.tags && review.tags.some(t =>
            ["rewarding", "helpful", "well-structured", "engaging"].includes(t.toLowerCase())
          ) && (
