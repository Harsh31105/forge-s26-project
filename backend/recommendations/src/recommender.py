...
from backend.recommendations.src.features import (
...
from backend.recommendations.api.schemas.rec_schemas import CourseFeatureRecord, RecommendationResult, UserProfileRecord
